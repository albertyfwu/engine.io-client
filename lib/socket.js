 ...
 */
 ...
 Socket.prototype.onDrain = function() {
  this.writeBuffer.splice(0, this.prevWriteBufferLen);
  this.flush();
 }
...
Socket.prototype.flush = function () {
  if ('closed' != this.readyState && this.transport.writable &&
    ...
    // keep track of current length of writeBuffer; splice on 'drain'
    this.prevWriteBufferLen = this.writeBuffer.length;
  }
};
